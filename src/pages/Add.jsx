    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      <div>
        ...
        <div className='w-full'>
            ...
            <textarea onChange={(e)=>setDescription(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2 ' type="text" placeholder='Type context here' required/>
        </div>
        ...
        <div className='flex gap-2 mt-2'>
            <input onChange={() => setEnableMinOrder(prev => !prev)} checked={enableMinOrder} type="checkbox" id='enableMinOrder'/>
            <label className='cursor-pointer' htmlFor="enableMinOrder">Set Minimum Order Quantity</label>
        </div>
